...
public class WalletController {
    ...
    @GetMapping("/point")
    public ResponseEntity<PointBalanceResponse> getWalletPoint(Authentication authentication) {
        PointBalanceResponse response = walletService.getPointBalance(authentication.getName());
